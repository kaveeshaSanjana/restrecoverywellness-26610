...
const Licensee = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <section className="py-20 bg-gradient-to-b from-black via-yellow-950/5 to-black/50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              See What a REST RECOVERY Location
              <span className="block text-yellow-400 mt-2">Looks Like</span>
            </h2>
            <p className="text-lg text-white/70">
              Explore our state-of-the-art facilities designed for optimal wellness and recovery
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex justify-center mb-6">
              <div className="inline-flex items-center gap-2 px-6 py-3 bg-yellow-500/20 border border-yellow-500/30 rounded-full backdrop-blur-sm">
                <Star className="w-5 h-5 text-yellow-400" />
                <span className="text-yellow-400 font-bold text-lg">Sneak Peek into REST RECOVERY</span>
                <Star className="w-5 h-5 text-yellow-400" />
              </div>
            </div>
            <Carousel 
            ...
            >
              <CarouselContent>
                <CarouselItem>
                  <div className="p-2">
                    <div className="rounded-2xl overflow-hidden border border-yellow-500/20">
                      <img 
                        src="/lovable-uploads/Gilbert-06.jpeg" 
                        alt="REST RECOVERY location interior view"
                ...
                <CarouselItem>
                  <div className="p-2">
                    <div className="rounded-2xl overflow-hidden border border-yellow-500/20">
                      <img 
                        src="/lovable-uploads/Gilbert-10.jpeg" 
                        alt="REST RECOVERY wellness equipment"
                        className="w-full h-[500px] object-cover"
                      />
                    </div>
                  </div>
                ...
                <CarouselItem>
                  <div className="p-2">
                    <div className="rounded-2xl overflow-hidden border border-yellow-500/20">
                      <img 
                        src="/lovable-uploads/Gilbert-29.jpeg" 
                        alt="REST RECOVERY therapy room"
                        className="w-full h-[500px] object-cover"
                      />
                    </div>
                  </div>
                ...
                <CarouselItem>
                  <div className="p-2">
                    <div className="rounded-2xl overflow-hidden border border-yellow-500/20">
                      <img 
                        src="/lovable-uploads/Gilbert-34.jpeg" 
                        alt="REST RECOVERY facility entrance"
                        className="w-full h-[500px] object-cover"
                      />
                    </div>
                  </div>
                ...
                <CarouselItem>
                  <div className="p-2">
                    <div className="rounded-2xl overflow-hidden border border-yellow-500/20">
                      <img 
                        src="/lovable-uploads/Gilbert-38.jpeg" 
                        alt="REST RECOVERY recovery area"
                        className="w-full h-[500px] object-cover"
                      />
                    </div>
                  </div>
                ...
                <CarouselItem>
                  <div className="p-2">
                    <div className="rounded-2xl overflow-hidden border border-yellow-500/20">
                      <img 
                        src="/lovable-uploads/Gilbert-16.jpeg" 
                        alt="REST RECOVERY treatment space"
                        className="w-full h-[500px] object-cover"
                      />
                    </div>
                  </div>
                ...
                <CarouselItem>
                  <div className="p-2">
                    <div className="rounded-2xl overflow-hidden border border-yellow-500/20">
                      <img 
                        src="/lovable-uploads/Gilbert-17.jpeg" 
                        alt="REST RECOVERY lounge area"
                        className="w-full h-[500px] object-cover"
                      />
                    </div>
                  </div>
                ...
                <CarouselItem>
                  <div className="p-2">
                    <div className="rounded-2xl overflow-hidden border border-yellow-500/20">
                      <img 
                        src="/lovable-uploads/Gilbert-13.jpeg" 
                        alt="REST RECOVERY location exterior"
                        className="w-full h-[500px] object-cover"
                      />
                    </div>
                  </div>
              ...
              <CarouselPrevious className="left-2 md:left-4 w-12 h-12 md:w-10 md:h-10 bg-yellow-500/20 border-yellow-500/30 hover:bg-yellow-500/30 text-white" />
              <CarouselNext className="right-2 md:right-4 w-12 h-12 md:w-10 md:h-10 bg-yellow-500/20 border-yellow-500/30 hover:bg-yellow-500/30 text-white" />
            </Carousel>
          </div>
        </div>
      </section>
