    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 bg-gradient-to-br from-black via-gray-900 to-black px-4 py-20">
        <div className="container mx-auto max-w-6xl">
          ...
          {/* Cut Sheets */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-white mb-6">Cut Sheets</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {/* Equipment Package - Master Sheet */}
              <Card className="bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-white text-lg">
                    <FileText className="h-5 w-5 text-primary" />
                    Equipment Package (Master)
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <a 
                    href="/documents/Rest_Recovery_Wellness_Equipment_Package_Cut_Sheet.pdf" 
                    download
                    className="block"
                  >
                    <Button variant="secondary" className="w-full">
              ...
              <Card className="bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all">
                ...
                <CardContent className="space-y-3">
                  <a 
                    href="/documents/Rest_Recovery_Red_Light_Pro3000_Cut_Sheet.pdf" 
                    download
                    className="block"
                  >
                    <Button variant="secondary" className="w-full">
              ...
              <Card className="bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all">
                ...
                <CardContent className="space-y-3">
                  <a 
                    href="/documents/Rest_Recovery_PEMF_Cut_Sheet.pdf" 
                    download
                    className="block"
                  >
                    <Button variant="secondary" className="w-full">
              ...
              <Card className="bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all">
                ...
                <CardContent className="space-y-3">
                  <a 
                    href="/documents/Rest_Recovery_Halo_Generator_Cut_Sheet.pdf" 
                    download
                    className="block"
                  >
                    <Button variant="secondary" className="w-full">
              ...
              <Card className="bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all">
                ...
                <CardContent className="space-y-3">
                  <a 
                    href="/documents/Rest_Recovery_Modern_Dream_Sauna_Cut_Sheet.pdf" 
                    download
                    className="block"
                  >
                    <Button variant="secondary" className="w-full">
              ...
              <Card className="bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all">
                ...
                <CardContent className="space-y-3">
                  <a 
                    href="/documents/Rest_Recovery_Peak_Cold_Pluge_Cut_Sheet.pdf" 
                    download
                    className="block"
                  >
                    <Button variant="secondary" className="w-full">
              ...
              <Card className="bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all">
                ...
                <CardContent className="space-y-3">
                  <a 
                    href="/documents/Rest_Recovery_Float_Spa_Cut_Sheet.pdf" 
                    download
                    className="block"
                  >
                    <Button variant="secondary" className="w-full">
              ...
              <Card className="bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 transition-all">
                ...
                <CardContent className="space-y-3">
                  <a 
                    href="/documents/Rest_Recovery_Soft_Shell_Hyperbaric_Cut_Sheet.pdf" 
                    download
                    className="block"
                  >
                    <Button variant="secondary" className="w-full">
